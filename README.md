<h1 align="center">Hi, I'm Amanda Siriwardane 👋</h1>
<h3 align="center">Computer Engineering Undergraduate | Developer | Designer</h3>
...
![SQL](https://img.shields.io/badge/SQL-00618A?style=for-the-badge)
...
**Key Contributions**
- Implemented full MERN-stack dashboard with **JWT auth, worker management, real-time visualization**
- Integrated **Two-Factor Authentication (2FA)** with Speakeasy  
- Managed cloud deployment: **Frontend → Netlify**, **Backend → Railway**
- Designed full dashboard UI/UX in Figma  

🔗 *[Repository link — add once public]*
...
**Skills Used:** Python • OpenCV • Image Processing • Matplotlib  
...
- **Team Player (Badminton)** – UoP  
- Member – **Rotaract Club of UoP**
...
<!--
**amandasiriwardane/amandasiriwardane** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
